...
class Staff(models.Model):
    ...
    staff_name = models.CharField(max_length=255, default="Please enter your name")
    staff_type = models.CharField(max_length=255, choices=type)
    created_at = models.DateTimeField(auto_now=True)

    def __str__(self):
        return self.staff_name + " " + self.staff_type
